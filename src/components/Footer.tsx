    ...
    <footer className="bg-background border-t dark:bg-background/90 transition-colors duration-300">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-muted-foreground dark:text-muted">
              Tu destino para la moda más actual. Ropa de calidad para toda la
              familia.
            </p>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-2 text-muted-foreground dark:text-muted">
              ...
              <li>
                <a href="#hombre" className="hover:text-foreground transition-colors">
                  Hombre
                </a>
              </li>
              <li>
          ...
          >
            ...
            <div className="space-y-3 text-muted-foreground dark:text-muted">
              <div className="flex items-center justify-center space-x-2">
                ...
                <span>cdgoldengoal6@gmail.com</span>
              </div>
              <div className="flex items-center justify-center space-x-2">
                <Phone className="h-4 w-4" />
                <span>3008198413 / +1 (240) 741-9140‬</span>
              </div>
              <div className="flex items-center justify-center space-x-2">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-12 pt-8 border-t flex flex-col md:flex-row items-center md:justify-between"
        >
          {/* Copyright - izquierda */}
          ...
          {/* Desarrollado por - centrado */}
          <div className="flex-1 flex justify-center items-center space-x-2 relative left-[-10px]">
